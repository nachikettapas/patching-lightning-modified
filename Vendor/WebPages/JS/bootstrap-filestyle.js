...
(function ($) {
  ...
  Filestyle.prototype = {
    ...
    disabled: function (value) {
      if (value === true || value === false) {
        ...
        if (this.options.disabled) { this.$elementFilestyle.find('label').css('opacity', '0.65') } else { this.$elementFilestyle.find('label').css('opacity', '1') }
      } else {
    ...
    size: function (value) {
      if (value !== undefined) {
        ...
        var btn = this.$elementFilestyle.find('label'); var input = this.$elementFilestyle.find('input')
    ...
    constructor: function () {
      ...
      if (_self.options.disabled || _self.$element.attr('disabled')) {
        ...
        if (_self.options.disabled) { _self.$elementFilestyle.find('label').css('opacity', '0.65') } else { _self.$elementFilestyle.find('label').css('opacity', '1') }
      }
  ...
  $.fn.filestyle = function (option, value) {
    var get = ''; var element = this.each(function () {
      if ($(this).attr('type') === 'file') {
        var $this = $(this); var data = $this.data('filestyle'); var options = $.extend({}, $.fn.filestyle.defaults, option, typeof option === 'object' && option)
  ...
  $.fn.filestyle.defaults = {
    'text': 'Browse',
    'htmlIcon': '',
    'btnClass': 'btn-secondary choose-file-btn',
    'size': 'nr',
    'input': true,
    'badge': false,
